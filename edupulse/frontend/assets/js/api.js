...
const EduAPI = (() => {
  ...
  const API_BASE = window.EDUPULSE_API_BASE || (location.origin.includes('null') ? 'http://localhost:4000' : location.origin);
  ...
  return { API_BASE, getToken, setToken, clearToken, getUser, setUser, request, requireLogin, openChatSocket, fileUrl, toast };
})();
